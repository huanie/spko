...
public class SExpressionParser extends Parser {
    ...
    public final SexpressionContext sexpression() throws RecognitionException {
        SexpressionContext _localctx =
                new SexpressionContext(_ctx, getState());
    ...
    public static class SexpressionContext extends ParserRuleContext {
        public SexpressionContext(ParserRuleContext parent,
                                  int invokingState) {
            super(parent, invokingState);
        }

        public TerminalNode LEFT_PAREN() {
            return getToken(SExpressionParser.LEFT_PAREN, 0);
        }
        ...
        public TerminalNode RIGHT_PAREN() {
            return getToken(SExpressionParser.RIGHT_PAREN, 0);
        }
        ...
        public TerminalNode LEFT_BRACKET() {
            return getToken(SExpressionParser.LEFT_BRACKET, 0);
        }

        public TerminalNode RIGHT_BRACKET() {
            return getToken(SExpressionParser.RIGHT_BRACKET, 0);
        }

        public TerminalNode LEFT_CURLY() {
            return getToken(SExpressionParser.LEFT_CURLY, 0);
        }

        public TerminalNode RIGHT_CURLY() {
            return getToken(SExpressionParser.RIGHT_CURLY, 0);
        }

        @Override public int getRuleIndex() {
            return RULE_sexpression;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof SExpressionParserListener)
                ((SExpressionParserListener) listener).enterSexpression(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof SExpressionParserListener)
                ((SExpressionParserListener) listener).exitSexpression(this);
        }
    }
    ...
    public static class HeadContext extends ParserRuleContext {
        ...
        public TerminalNode SYMBOL() {
            return getToken(SExpressionParser.SYMBOL, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof SExpressionParserListener)
                ((SExpressionParserListener) listener).enterHead(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof SExpressionParserListener)
                ((SExpressionParserListener) listener).exitHead(this);
        }
    }
    ...
    public static class RestContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof SExpressionParserListener)
                ((SExpressionParserListener) listener).enterRest(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof SExpressionParserListener)
                ((SExpressionParserListener) listener).exitRest(this);
        }
    }
}